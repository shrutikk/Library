...
%>
<tr>
<td><a href="<%=request.getContextPath()%>/GetBookDetails?ISBN=<%=allbooks.getString(1) %>"><%=allbooks.getString(1) %></a></td>
...
%>
<tr>
<td><a href="<%=request.getContextPath()%>/GetJournalDetails?ISSN=<%=alljournals.getString(1) %>"><%=alljournals.getString(1) %></a></td>
...
%>
<tr>
<td><a href="<%=request.getContextPath()%>/GetConfDetails?CONFNO=<%=allconfs.getString(1) %>"><%=allconfs.getString(1) %></a></td>
