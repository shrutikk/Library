...
/**
 * Servlet implementation class CheckInCamera
 */
@WebServlet("/CheckInCamera")
public class CheckInCamera extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			stmt = (CallableStatement) conn.prepareCall("{call checkInCamera(?,?)}");
