...
/**
 * Servlet implementation class CheckInDocument
 */
@WebServlet("/CheckInDocument")
public class CheckInDocument extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			stmt = (CallableStatement) conn.prepareCall("{call checkInDocument(?,?)}");
