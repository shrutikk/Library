...
/**
 * Servlet implementation class ReserveJournal
 */
@WebServlet("/ReserveJournal")
public class ReserveJournal extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReserveJournal() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String issn = (String) sess.getAttribute("ISSN");
		...
		System.out.println(sess.getAttribute("patronid"));
			...
			try {
		            ...
		            stmt.executeUpdate();
		            request.setAttribute("journalresstatus", stmt.getString(5));
